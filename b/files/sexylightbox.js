...
function hidedivSexy()
{
var divid = document.getElementById("ifloadingdiv");
if(window.chrome)
{
    ...
    overlay: {
      ...
      inject: function() {
        ...
        // Me cago en John Resig
        {
          ...
          //alert("Iframe");
		  this.shim = $('<iframe id="IF_'+new Date().getTime()+'" scrolling="no" frameborder=0 src="" allowTransparency="true"></div>');
		this.shim.css({
            zIndex    : zIndex,
            position  : 'absolute',
            top       : 0,
    ...
    */
    ...
    showIframe: function(src, size, bg) {
      ...
      this.Contenido.empty().css({
        ...
        'background-color'  : size['background'] || '#ffffff',
        'padding'           : '0px'
      }).append('<div id="ifloadingdiv" style="width:100%;height:100%;left: 0px;opacity: 0.7;background-color: #fff;z-index: 99;text-align: center;"><b style="font-size:14px;">loading..</b></div><iframe id="'+id+'" frameborder="0" onload=hidedivSexy();></iframe>');
